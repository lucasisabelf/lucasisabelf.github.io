...
export function PasteHintBanner({ onDismiss }: PasteHintBannerProps) {
  return (
    <div className="no-print flex items-center justify-between gap-3 my-3 px-3 py-2.5 rounded-md text-sm bg-feedback-bg border border-feedback-border text-feedback-color">
